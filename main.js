...
function africa() {
  ...
  //   // let africaQuestions = [
  //   //   { question: 'You can climb up the Mount Kilimanjaro, which country would you go?', answer: 'Tanzania' },
  //   //   { question: 'You can visit the Table Mountain and overlook the Cape Town Bay, which country should you be?', answer: 'South Africa' },
  //   //   { question: 'You will visit the world\'s most famous pyramides. Which country will you go?', answer: 'Egypt' },

  //   // const africanCountries = ['Algeria', 'Angola', 'Benin', 'Botswana', 'Cabo Verde', 'Cameroon', 'Cote d\'Ivoire', 'Egypt', 'Equatorial Guinea', 'Ethiopia', 'Gabon', 'Ghana', 'Guinea', 'Kenya', 'Madagascar', 'Malawi', 'Mauritius', 'Morocco', 'Mozambique', 'Nigeria', 'Rwanda', 'Senegal', 'South Africa', 'Tanzania', 'Uganda', 'Zambia', 'Zimbabwe', 'Togo', 'Seychelles', 'Somalia', 'Chad'];
